...
public struct SRWindowInfo: CustomDebugStringConvertible {
    ...
    fileprivate var descriptionDictionary: [String: Any]? {
        ...
        print("window ID \(windowID) descriptions: \(descriptions)")
    ...
    public var name: String {
        print("description dictionary: \(String(describing: descriptionDictionary))")
    ...
    private static var frontmostWindowElement: AXUIElement? {
        ...
        guard AXUIElementCopyAttributeValue(app! as! AXUIElement, convertFromNSAccessibilityAttribute(NSAccessibility.Attribute.focusedWindow) as CFString, &window) == .success else {
...
fileprivate func convertFromNSAccessibilityAttribute(_ input: NSAccessibility.Attribute) -> String {
