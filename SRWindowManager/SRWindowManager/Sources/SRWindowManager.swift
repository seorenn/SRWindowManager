...
public class SRWindowManager: CustomDebugStringConvertible {
    ...
    private func startDetector() {
        ...
        self.nc.addObserver(forName: NSWorkspace.didActivateApplicationNotification, object: nil, queue: OperationQueue.main, using: {
            ...
            guard let application = userInfo[NSWorkspace.applicationUserInfoKey] as? NSRunningApplication else {
